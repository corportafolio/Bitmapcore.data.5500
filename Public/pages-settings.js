          ...
          React.createElement('div', { className:'space-y-4' },
            React.createElement('div', null,
              ...
              React.createElement('input', {
                ...
                placeholder:I18n.t('settings.alias'),
            ...
            walletState.isConnected ? React.createElement('div', { className:'bg-bitmap-black/50 rounded-lg p-3 border border-bitmap-border' },
              React.createElement('div', { className:'font-acme text-xs text-bitmap-muted' }, I18n.t('settings.walletConnected')),
              ...
              React.createElement('button', { onClick:function() { StoreApp.dispatch({ type:'DISCONNECT_WALLET' }); }, className:'mt-2 px-3 py-1 text-xs bg-bitmap-red text-white rounded hover:bg-bitmap-red/80' }, I18n.t('settings.disconnect'))
            ) : React.createElement('div', { className:'bg-bitmap-black/50 rounded-lg p-3 border border-bitmap-border' },
              React.createElement('div', { className:'font-acme text-xs text-bitmap-muted' }, I18n.t('settings.walletNotConnected')),
              React.createElement('button', { onClick:function() { navigate('/wallet'); }, className:'mt-2 px-3 py-1 text-xs bg-bitmap-orange text-white rounded hover:bg-bitmap-orange/80' }, I18n.t('settings.connectWallet'))
            )
          )
        ),
            ...
            React.createElement('div', null,
              ...
              React.createElement('div', { className:'grid grid-cols-2 gap-3' },
                ['dark', 'light'].map(function(t) {
                  ...
                  }, t === 'dark' ? '\uD83D\uDD75\uFE0F ' + I18n.t('settings.dark') : '\u2600\uFE0F ' + I18n.t('settings.light'));
                })
              )
            ),
            React.createElement('div', null,
