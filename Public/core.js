(function() {
  ...
  function AppRoutes() {
    ...
    return React.createElement(Routes, null,
      ...
      React.createElement(Route, { path:'/collections/bitmap', element:wrapper(safe(LocalPage)) }),
      ...
      React.createElement(Route, { path:'/collections/bitticks-agents', element:wrapper(safe(BittickAgentsPage)) }),
      React.createElement(Route, { path:'/add-collection', element:wrapper(safe(AddCollectionPage)) }),
      React.createElement(Route, { path:'/collections', element:wrapper(safe(CollectionsListPage)) }),
      React.createElement(Route, { path:'/collections/:slug', element:wrapper(safe(CollectionsMarketPage)) }),
