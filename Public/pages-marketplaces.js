...
function SatflowPage(props) {
  ...
  var statsUnchanged = _i[0];
  var setStatsUnchanged = _i[1];
  var _j = React.useState('polling');
  var connectionStatus = _j[0];
  var setConnectionStatus = _j[1];
  ...
  React.useEffect(function() {
    ...
    var unsub9 = vm.subscribe('connection', function() { setConnectionStatus(vm.getConnectionStatus()); });
    return function() {
  ...
  var searchQuery = _k[0];
  var setSearchQuery = _k[1];
