                ...
                React.createElement('div', { style:{ display:'flex', flexWrap:'nowrap', overflow:'hidden', gap:'4px' } },
                  tags.slice(0, 3).map(function(tag, ti) {
                    return React.createElement('span', {
                      key: ti,
                      style:{ display:'inline-block', backgroundColor:'#8B2500', color:'#000', border:'1px solid #B53D00', boxShadow:'inset 0 2px 6px rgba(0,0,0,0.5)', fontSize:'7px', borderRadius:'8px', padding:'1px 4px', whiteSpace:'nowrap', fontFamily:'Alfa Slab One, serif', fontWeight:'bold', lineHeight:'1.2' }
                    }, tag.trim());
                  })
                ),
React.createElement('img', {
